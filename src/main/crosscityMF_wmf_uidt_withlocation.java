...
import algorithms.MF_ALS_uidt_withlocation;


public class crosscityMF_wmf_uidt_withlocation extends main_crosscity {
	public static void main(String argv[]) throws IOException {
		...
		String kmeansfile = "data/yelp/yelp_poi_info_code";
		int R = 1;
		if (argv.length > 0) {
			//dataset_name = argv[0];
			//method = argv[1];
		...
		if (true) {
			algorithms.MF_ALS_uidt_withlocation als = new algorithms.MF_ALS_uidt_withlocation(trainMatrix, testRatings, topK, threadNum,
			...
			String outpath = "orderoutputfile/alsmix_stlda_"+datafile_write+"_w0_"+w0+"_reg_"+reg+
