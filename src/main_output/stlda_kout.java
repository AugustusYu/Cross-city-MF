...
public class stlda_kout extends main.main_crosscity{
	public static void main(String argv[]) throws IOException {
		...
		int BURN_IN = 0;
		int maxoutput = 10;
		String KMeansFile = "data/yelp/yelpkmeans10";
		...
		String outpath = "Kout/stlda_"+datafile_write+"_K_"+R+"_city"+nativecity;
